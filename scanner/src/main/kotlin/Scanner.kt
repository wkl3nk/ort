...
class Scanner(
    ...
    val archiver: FileArchiver? = scannerConfig.archive.createFileArchiver(),
    val fileListStorage: ProvenanceFileStorage = scannerConfig.fileListStorage.createStorage()
) {
